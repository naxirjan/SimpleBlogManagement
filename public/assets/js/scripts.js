function loadStyle(e, t) {
    ...
    var t = "dore.light.orangecarrot.min.css",
        o = "ltr",
        a = "rounded";
    try {
        ...
        t = "dore.light.orangecarrot.min.css", o = "ltr", a = "rounded"
    }
    ...
    e(".theme-color[data-theme='" + t + "']").addClass("active"), e(".direction-radio[data-direction='" + o + "']").attr("checked", !0), e(".radius-radio[data-radius='" + a + "']").attr("checked", !0), e("#switchDark").attr("checked", t.indexOf("dark") > 0),
