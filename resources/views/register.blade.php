        ...
        <div class="row h-100">
            <div class="col-12 col-md-10 mx-auto my-auto">
                <div class="card auth-card">
                    ...
                    <div class="form-side">
                        <h6 class="mb-4 font-weight-bold">Register</h6>
                        <form id="exampleForm" method="POST" action="/registerProcess" class="tooltip-right-bottom" novalidate>
                            <x-text-field-floating-label id="name" name="name" type="text" text="Name" value="{{old('name')}}" required="" />
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <x-button class="btn btn-primary btn-shadow" type="submit" text="REGISTER" />
                                @csrf
                            </div>
                        </form>
                    </div>
